...
<html lang="pt-BR">
    ...
    <body>
            ...
            <div class="container">
                <nav>
                    ...
                    <div class="nav-links">
                        ...
                        <a href="contactoAdmin.html">Contacto</a>
                    </div>
        ...
        <main class="container">
            <h1 class="section-title">Gestão de Vendas</h1>

            <!-- Seção de Cadastro de Vendas -->
            <section class="form-section">
                <!--                <div class="form-container">
                                    <h2 class="form-title">Registrar Nova Venda</h2>
                                    <form action="salvarVenda.jsp" method="post">
                                        <div class="form-row">
    ...
    <button type="submit" class="btn btn-success btn-block">Registrar Venda</button>
                ...
                <div class="table-container">
                    ...
                    <table class="sales-table">
                        ...
                        <tbody>
                            <%@include file="listarVendas.jsp"%>
                        </tbody>
                    </table>
                    <div class="total-sales">
                        Total de Vendas em Milhares: Mts <span id="total-vendas">0,00</span>
                    </div>
                </div>
            </section>
        </main>
